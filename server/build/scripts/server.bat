...
set CLASSPATH=%APP_HOME%\lib\server-1.0.jar;%APP_HOME%\lib\core-1.0.jar;%APP_HOME%\lib\gdx-box2d-1.9.10.jar;%APP_HOME%\lib\gdx-1.9.10.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" org.lordsofchaos.server.GameServer %CMD_LINE_ARGS%
