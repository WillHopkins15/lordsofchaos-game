...
public class MapGenerator {
    ...
    private static ArrayList<Coordinates> path2 = new ArrayList<Coordinates>(
            Arrays.asList(new MatrixCoordinates(0, 5), new MatrixCoordinates(1, 5), new MatrixCoordinates(2, 5),
                    ...
                    new MatrixCoordinates(15, 8), new MatrixCoordinates(15, 9), new MatrixCoordinates(15, 10),
                    new MatrixCoordinates(15, 11), new MatrixCoordinates(15, 12), new MatrixCoordinates(15, 12),
                    new MatrixCoordinates(15, 14), new MatrixCoordinates(14, 14), new MatrixCoordinates(14, 15),
                    new MatrixCoordinates(14, 16), new MatrixCoordinates(14, 17), new MatrixCoordinates(14, 18),
                    new MatrixCoordinates(15, 18), new MatrixCoordinates(16, 18), new MatrixCoordinates(17, 18),
    ...
    private static ArrayList<Coordinates> path3 = new ArrayList<Coordinates>(
            Arrays.asList(new MatrixCoordinates(0, 15), new MatrixCoordinates(1, 15), new MatrixCoordinates(2, 15),
                    ...
                    new MatrixCoordinates(15, 9), new MatrixCoordinates(16, 9), new MatrixCoordinates(17, 9),
                    new MatrixCoordinates(18, 9), new MatrixCoordinates(18, 10), new MatrixCoordinates(18, 11),
                    new MatrixCoordinates(18, 12), new MatrixCoordinates(18, 13), new MatrixCoordinates(18, 14),
                    new MatrixCoordinates(18, 15), new MatrixCoordinates(18, 16), new MatrixCoordinates(18, 17),
                    new MatrixCoordinates(18, 18)));
