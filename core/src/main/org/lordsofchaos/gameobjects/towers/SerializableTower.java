...
/**
 * SerializableTower tells you what sort of tower has been placed and where, GameController then
 * uses this to create instances of towers. GameController contains a list of SerializableTowers
