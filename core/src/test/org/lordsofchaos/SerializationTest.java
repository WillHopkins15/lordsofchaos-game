...
public class SerializationTest {
    ...
    public void testWaveStateIsSerializable() {
        ...
        //Deserialize Object
        GameController.WaveState newWavestate = (GameController.WaveState) client
    ...
    public void testSerializableTowerIsSerializable() {
        SerializableTower tower = new SerializableTower(TowerType.type1,
            new RealWorldCoordinates(12, 34));
